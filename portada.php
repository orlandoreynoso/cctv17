...
<section class="slide">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      ?>
      <?php 
        echo do_shortcode("[metaslider id=3519]"); 
      ?>
    </div>
  </div>  
</section> 
...
<section class="player-seccions">
  ...
  <div class="seccions">
    <a href="<?php bloginfo('url'); ?>/donaciones" class="secciones seccions_1">
        <h2><span class="icon-library fa fa-bank"></span>Ayúdanos >> Cuentas Bancarias</h2>
    </a>
    <a  href="<?php bloginfo('url'); ?>/amigos" class="secciones seccions_2">
        <h2><span class="icon-cogs fa fa-cog"></span>Amigos</h2>
    </a>
    <a  href="<?php bloginfo('url'); ?>/programas" class="secciones seccions_3">
        <h2><span class="icon-cogs fa fa-tv"></span>Programas</h2>
    </a>
    <a  href="<?php bloginfo('url'); ?>/cobertura" class="secciones seccions_4">
        <h2><span class="icon-location2 fa fa-map-marker"></span>Cobertura</h2>     
    </a>
  </div>
</section>
