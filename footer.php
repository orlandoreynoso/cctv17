...
<footer id="footer">
	<div class="footer-slogan">"Para que Jesucristo sea más conocido, amado y seguido"</div>
	<div class="group">
		<div id="direccion">
			<p>Teléfonos: (502) 2251-1244 / (502) 2238-0593</p> 
			<p>Dirección: 5ta. Calle 3-61 Zona 1</p>
